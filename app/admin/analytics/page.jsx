...
export default function AnalyticsPage() {
  ...
  const topProducts = [
    { name: "Dark Chocolate Truffles", sales: 124, revenue: 16119.76 },
    { name: "Milk Chocolate Gift Box", sales: 98, revenue: 19599.02 },
    { name: "Chocolate Covered Strawberries", sales: 87, revenue: 7829.13 },
    { name: "Assorted Fudge", sales: 65, revenue: 5849.35 },
    { name: "Chocolate Chip Cookies", sales: 42, revenue: 16799.58 },
  ]
  ...
  const COLORS = ["#8B4513", "#D2691E", "#CD853F", "#A0522D", "#FFDEAD"]
            ...
            <div className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={customerData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="new" name="New Customers" fill="#8B4513" />
                  <Bar dataKey="returning" name="Returning Customers" fill="#D2691E" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
              ...
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={salesData}>
                    ...
                    />
                    <Legend />
                    <Bar dataKey="total" name="Revenue" fill="#8B4513" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
            ...
            <div className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={salesData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="total" name="Sales" stroke="#8B4513" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
  ...
  return (
    <div className="space-y-6">
      ...
      {reportType === "customers" && renderCustomersContent()}
    </div>
  )
}
