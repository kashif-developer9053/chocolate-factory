...
export default function MainNav() {
  ...
  const routes = [
    ...
    { href: "/contact", label: "Contact", active: pathname === "/contact" },
        { href: "/privacy", label: "Privacy Policy", active: pathname === "/privacy" },
  ...
  const renderMobileUserSection = () => {
    ...
    return (
      <div className="flex items-center justify-between pt-4 border-t">
        <Link href="/login" className="text-sm font-medium hover:text-primary" onClick={() => setIsMenuOpen(false)}>Login</Link>
        <Link href="/register" className="text-sm font-medium hover:text-primary" onClick={() => setIsMenuOpen(false)}>Register</Link>
      </div>
    )
  }
    ...
    <div className="flex w-full items-center justify-between">
      <div className="flex items-center">
        ...
        <Link href="/" className="mr-6 flex items-center space-x-2">
          <img src={logoUrl} alt="The Chocolate Factory" className="h-10 w-auto" />
        </Link>
      ...
      <div className="hidden items-center gap-4 md:flex">
        ...
        <Button variant="ghost" size="icon" asChild className="relative">
          <Link href="/cart">
            ...
            {cartCount > 0 && (
              <Badge variant="destructive" className="absolute -right-1 top-1 h-4 w-4 rounded-full p-0 text-xs flex items-center justify-center">
                {cartCount}
              </Badge>
            )}
      ...
      {isMenuOpen && (
        <div className="absolute inset-x-0 top-16 z-50 w-full bg-background p-5 shadow-lg border-b md:hidden">
